    ...
    <Container className="py-4">
        ...
        <Row className='g-4 mt-4'>
            ...
            <Card className='h-100 shadow-sm'>
                <Card.Body className='text-center h-100 shadow-sm'>
                    <Card.Title> Parcerias com Empresas</Card.Title>
                    <Card.Text> A UNIESP mantém parcerias com diversas empresas, permitindo que nossos alunos tenham acesso a oportunidades de estágio e emprego logo após a graduação </Card.Text>
                </Card.Body>
            </Card>
            </Col>
            ...
            <Card className='h-100 shadow-sm'>
                <Card.Body className='text-center h-100 shadow-sm'>
                    ...
                    <Card.Text> A UNIESP se dedica a oferecer uma educação acessível e de qualidade, acreditando que o conhecimento transforma vidas </Card.Text>
                </Card.Body>
            </Card>
            </Col>
        </Row>
