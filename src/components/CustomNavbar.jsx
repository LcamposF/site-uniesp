    ...
    <>
     <Navbar expand='md' style={{ backgroundColor: '#002F6C'}} variant='dark' className='px-3 shadow-sm'>
        <Container fluid>
            ...
            <img src='/uniesp.png' alt='Uniesp Logo' width={60} className='me-2 rounded'/>
            </Navbar.Brand>
        ...
        {/* Menu lateral (Offcanvas) visível telas pequenas ao clicar no botão hamburguer*/}

        <Offcanvas show={show} inHide={handleClose}>
          ...
          <Offcanvas.Body> 
            ...
            <Nav className='flex-column'>
              {/* Cada intem de menu fecha o Offcanvas ao ser clicado */}
